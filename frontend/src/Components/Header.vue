  ...
  <div class="container-flex">
    <nav class="navbar navbar-light">
      ...
      <span class="navbar-item bc d-none d-xl-block d-lg-block py-0">
        ...
        <router-link class="px-5" to="/">{{ username }}</router-link>
      </span>
      ...
      <p class="navbar-item ml-auto">
        ...
        <router-link to="/signup">
          <div class="user">
            <h5 style="cursor: pointer">Sign Up</h5>
          </div>
        </router-link>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body">
            ...
            <form class="px-3 py-2" v-on:submit.prevent="login">
              ...
              <button class="btn-xl btn-success mt-3">Sign in</button>
            </form>
          </div>
